...
PRODUCT_COPY_FILES += \
    ...
    device/moto/shamu_t/rootdir/etc/init.qcom.devwait.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.qcom.devwait.sh \
    device/moto/shamu_t/rootdir/etc/init.qcom.devstart.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.qcom.devstart.sh
...
# Audio
PRODUCT_COPY_FILES += \
    device/moto/shamu_t/audio/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.xml \
    device/moto/shamu_t/audio/audio_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.xml \
    device/moto/shamu_t/audio/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
    device/moto/shamu_t/audio/audio_policy_volumes_drc.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_drc.xml \
    device/moto/shamu_t/audio/mixer_paths.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.xml \
    device/moto/shamu_t/audio/motvr_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/motvr_audio_policy_configuration.xml \
...
PRODUCT_COPY_FILES += \
    device/moto/shamu_t/media_profiles_V1_0.xml:system/vendor/etc/media_profiles_V1_0.xml \
...
PRODUCT_COPY_FILES += \
    ...
    device/moto/shamu_t/nfc/nfcee_access.xml:system/etc/nfcee_access.xml \
    device/moto/shamu_t/nfc/libnfc-brcm.conf:system/vendor/etc/libnfc-brcm.conf \
    device/moto/shamu_t/nfc/libnfc-brcm-20795a10.conf:system/vendor/etc/libnfc-brcm-20795a10.conf
