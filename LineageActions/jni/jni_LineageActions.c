...
JNIEXPORT jboolean JNICALL Java_org_lineageos_settings_device_IrGestureManager_nativeSetIrDisabled(
     UNUSED JNIEnv *env, UNUSED jclass thiz, jboolean disabled)
{
    return set_ir_disabled(disabled == JNI_TRUE) ? JNI_FALSE : JNI_TRUE;
}

JNIEXPORT jboolean JNICALL Java_org_lineageos_settings_device_IrGestureManager_nativeSetIrWakeConfig(
